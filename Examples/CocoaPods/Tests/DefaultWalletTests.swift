...
class DefaultWalletTests: XCTestCase {
   ...
   func testCreateOrder() throws {
        ...
        let result = try wallet.buildSignedOrder(recepient: "0x823b6a996cea19e0c41e250b20e2e804ea72ccdf", sell: tokenSell, buy: tokenBuy, ratio: (1, 2), amount: 1000000, nonce: 18, timeRange: .max)
...
extension ChangePubKey: Equatable where T == ChangePubKeyOnchain {
    ...
    static var defaultTX: ChangePubKey<ChangePubKeyOnchain> {
        let tx = ChangePubKey<ChangePubKeyOnchain>(accountId: 55,
                                                   ...
                                                   nonce: 13,
                                                   timeRange: TimeRange(validFrom: 0, validUntil: 4294967295))
        tx.signature = Signature(pubKey: "40771354dc314593e071eaf4d0f42ccb1fad6c7006c57464feeb7ab5872b7490", signature: "85782959384c1728192b0fe9466a4273b6d0e78e913eea894b780e0236fc4c9d673d3833e895bce992fc113a4d16bba47ef73fed9c4fca2af09ed06cd6885802")
...
extension Order: Equatable {
    ...
    static var defaultOrder: Order {
        var order = Order(accountId: 6,
                          ...
                          amount: 1000000,
                          timeRange: .max)
        order.ethereumSignature = EthSignature(signature: "0x841a4ed62572883b2272a56164eb33f7b0649029ba588a7230928cff698b49383045b47d35dcdee1beb33dd4ca6b944b945314a206f3f2838ddbe389a34fc8cb1c", type: .ethereumSignature)
        order.signature = Signature(pubKey: "40771354dc314593e071eaf4d0f42ccb1fad6c7006c57464feeb7ab5872b7490", signature: "b76c83011ea9e14cf679d35b9a7084832a78bf3f975c5b5c3315f80993c227afb7a1cd7e7b8fc225a48d8c9be78335736115890df5bbacfc52ecf47b4e089500")
        return order
    }
